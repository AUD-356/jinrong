...
$loans = dbGetAll("SELECT * FROM loans WHERE user_id = ? AND user_type = 'enterprise' ORDER BY created_at DESC LIMIT 10", [$enterpriseId]);

$products = dbGetAll("SELECT * FROM loan_products WHERE user_type IN ('enterprise', 'all') AND status = 'active' ORDER BY sort_order");
?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <title>企业贷款 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-cash-stack me-2"></i>企业贷款</h2>
        ...
        <div class="quick-action">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h4><i class="bi bi-lightning-charge me-2"></i>企业快速融资通道</h4>
                    <p>专业企业金融服务，助力企业发展，快速审批，高效放款</p>
                </div>
                <div class="col-md-4 text-end">
                    <span class="badge bg-light text-dark fs-6"><i class="bi bi-bank me-1"></i>正规安全</span>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="card-box mb-4">
            <div class="card-title">
                <i class="bi bi-collection me-2"></i>企业贷款产品
            </div>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="card product-card h-100">
                        <div class="card-body p-4">
                            ...
                            <?php if (!$hasActiveLoan): ?>
                            <a href="loan_apply.php?product_id=<?php echo $product['id']; ?>" class="btn btn-success w-100">
        ...
        <div class="card-box">
            <div class="card-title">
                <i class="bi bi-list-ul me-2"></i>企业贷款记录
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="loan_detail.php?id=<?php echo $loan['id']; ?>" class="btn btn-sm btn-outline-success">
