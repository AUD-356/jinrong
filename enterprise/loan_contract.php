        ...
        <div class="contract-box" style="max-width: 800px; margin: 0 auto;">
            ...
            <div class="contract-content mb-4">
                ...
                <div class="mb-4 pb-4 border-bottom border-gray-200">
                    ...
                    <p class="no-indent mb-1"><strong>乙方（借款人）：</strong><?php echo htmlspecialchars($enterprise['company_name']); ?></p>
                    <p class="no-indent"><strong>统一社会信用代码：</strong><?php echo $enterprise['tax_id']; ?></p>
                    <p class="no-indent"><strong>法定代表人：</strong><?php echo htmlspecialchars($enterprise['legal_person']); ?></p>
                </div>
                ...
                <h6>第四条 权利与义务</h6>
                <p>甲方有权按照本合同约定收取贷款本金和利息；乙方应按照本合同约定按时足额偿还贷款本息。如乙方提前还款，需提前7个工作日向甲方提出书面申请，经甲方同意后方可办理。乙方保证所提供的企业资料真实有效，并承担因资料不实所产生的一切法律责任。</p>
                
                <h6>第五条 违约责任</h6>
                <p>如乙方未按约定日期还款，甲方有权按逾期天数收取罚息，罚息利率为合同约定利率的1.5倍。连续逾期超过30天的，甲方有权宣布贷款提前到期，要求乙方立即偿还全部剩余本息，并追究乙方的违约责任。</p>
                
                <h6>第六条 争议解决</h6>
                <p>本合同履行过程中如发生争议，双方应友好协商解决；协商不成的，任何一方均有权提交甲方所在地有管辖权的人民法院诉讼解决。</p>
                
                <h6>第七条 其他条款</h6>
                <p>本合同自双方签字（盖章）之日起生效，一式两份，甲乙双方各执一份，具有同等法律效力。本合同未尽事宜，可由双方另行签订补充协议。乙方承诺已获得企业内部必要的授权签署本合同。</p>
                ...
                <div class="contract-signatures">
                    ...
                    <div class="signature-block">
                        <div class="signature-label">乙方（盖章）</div>
                        <div class="signature-line"></div>
                        <div class="mt-2 text-sm text-muted"><?php echo htmlspecialchars($enterprise['company_name']); ?></div>
                    </div>
                </div>
                ...
                <div class="border border-dashed border-gray-300 rounded-lg p-4 mb-4">
                    <div class="form-check mb-4">
                        ...
                        <label class="form-check-label" for="agreeContract">
                            <strong>我已认真阅读并同意</strong>《企业贷款合同》的所有条款，代表企业自愿签署本合同。
                        </label>
                    </div>
                    
                    <div class="signature-canvas-wrapper">
                        <h6 class="text-center mb-3"><i class="bi bi-pencil-square me-2"></i>乙方法定代表人手写签名</h6>
