...
$where = "user_id = ? AND user_type = 'enterprise'";
$params = [$enterpriseId];
...
<head>
    ...
    <title>企业账单明细 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-file-earmark-text me-2"></i>企业账单明细</h2>
        ...
        <div class="card-box">
            <div class="card-title d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-sm btn-outline-success" onclick="exportBills()">
    ...
    <script>
        function exportBills() {
            exportTable('billsTable', '企业账单明细_<?php echo date('Ymd'); ?>');
        }
    </script>
</body>
</html>
