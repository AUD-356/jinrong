...
<head>
    ...
    <title>企业账户设置 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-gear me-2"></i>企业账户设置</h2>
            ...
            <div class="col-md-9">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="profile">
                        <div class="card-box">
                            ...
                            <form action="settings_profile_do.php" method="POST">
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">企业名称</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="company_name" value="<?php echo htmlspecialchars($enterprise['company_name']); ?>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">统一社会信用代码</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($enterprise['tax_id'] ?? ''); ?>" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">法人代表</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="legal_person" value="<?php echo htmlspecialchars($enterprise['legal_person']); ?>" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">联系电话</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?php echo maskPhone($enterprise['contact_phone'] ?? ''); ?>" readonly>
                                ...
                                <div class="row mb-3">
                                    <label class="col-md-3 col-form-label">企业地址</label>
                                    <div class="col-md-9">
                    ...
                    <div class="tab-pane fade" id="paypassword">
                        <div class="card-box">
                            <div class="card-title">
                                <i class="bi bi-shield-lock me-2"></i><?php echo empty($enterprise['pay_password']) ? '设置' : '修改'; ?>支付密码
                            </div>
                            ...
                            <?php if (empty($enterprise['pay_password'])): ?>
                            ...
                            <form action="settings_paypassword_do.php" method="POST">
                                ...
                                <?php endif; ?>
                                <div class="mb-3">
                                    <label class="form-label"><?php echo empty($enterprise['pay_password']) ? '设置' : '修改'; ?>支付密码</label>
                                ...
                                <button type="submit" class="btn btn-success"><?php echo empty($enterprise['pay_password']) ? '设置' : '修改'; ?>支付密码</button>
                            </form>
                        </div>
                    </div>
                </div>
