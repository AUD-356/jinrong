    ...
    <div class="login-page">
        <div class="login-card" style="width: 550px;">
            <div class="card-header">
                <h3><i class="bi bi-check-circle me-2"></i>企业贷款申请已提交</h3>
            ...
            <div class="card-body">
                <div class="text-center mb-4">
                    ...
                    <i class="bi bi-file-earmark-check text-success" style="font-size: 64px;"></i>
                    <?php else: ?>
                ...
                <table class="table table-bordered">
                    <tr>
                        <th width="35%">回执单号</th>
                        <td><strong class="text-success"><?php echo htmlspecialchars($receiptNo); ?></strong></td>
                    </tr>
                    <tr>
                        <th>贷款金额</th>
                ...
                <div class="alert alert-info mt-4">
                    ...
                    请保存好回执单号，审核结果将会通过系统通知您。审核通常需要3-7个工作日。
                </div>
                <?php endif; ?>
                
                <div class="d-grid gap-2 mt-4">
                    <a href="loan.php" class="btn btn-success">
