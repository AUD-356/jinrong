...
<head>
    ...
    <title>银行卡管理 - <?php echo SITE_NAME; ?></title>
    ...
    <div class="main-content">
        ...
        <div class="card-box">
            <div class="empty-state">
                ...
                <a href="cards_apply.php" class="btn btn-primary btn-lg">
        ...
        <div class="card-box">
            <div class="card-title d-flex justify-content-between align-items-center">
                ...
                <a href="cards_apply.php" class="btn btn-primary btn-sm">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="cards_detail.php?id=<?php echo $card['id']; ?>" class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
