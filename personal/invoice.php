...
<head>
    ...
    <title>发票申请 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-receipt me-2"></i>发票申请</h2>
        ...
        <div class="row">
                    ...
                    <form action="invoice_do.php" method="POST" id="invoiceForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type" 
                                               id="typePersonal" value="personal" checked required>
                                        <label class="form-check-label" for="typePersonal">
                                            <i class="bi bi-person me-1"></i>个人发票
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="radio" name="type" 
                                               id="typeEnterprise" value="enterprise">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3" id="taxIdField" style="display: none;">
            ...
            <div class="col-md-4">
                ...
                <div class="card-box mt-4">
                    ...
                    <?php
                    $invoices = dbGetAll("SELECT * FROM invoices WHERE user_id = ? AND user_type = 'personal' ORDER BY created_at DESC LIMIT 5", [$userId]);
                    if (empty($invoices)):
                    ?>
    ...
    <script>
        document.getElementById('typePersonal').addEventListener('change', function() {
            document.getElementById('taxIdField').style.display = 'none';
            document.querySelector('input[name="tax_id"]').removeAttribute('required');
        });
        
        document.getElementById('typeEnterprise').addEventListener('change', function() {
            document.getElementById('taxIdField').style.display = 'block';
            document.querySelector('input[name="tax_id"]').setAttribute('required', 'required');
        });
    </script>
</body>
</html>
