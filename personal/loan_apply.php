...
if ($productId > 0) {
    $product = dbGetRow("SELECT * FROM loan_products WHERE id = ? AND user_type IN ('personal', 'all') AND status = 'active'", [$productId]);
} else {
    $product = null;
}
?>
...
<head>
    ...
    <title>申请贷款 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-file-earmark-text me-2"></i>申请贷款</h2>
            ...
            <div class="row text-center">
                <div class="col-4">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <span class="mt-2 fw-bold text-primary">1. 选择产品</span>
                    </div>
                </div>
                <div class="col-4">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <span class="mt-2 fw-bold text-primary">2. 填写申请</span>
                    </div>
                </div>
                <div class="col-4">
                    <div class="d-flex flex-column align-items-center">
                ...
                <div class="card-box">
                    ...
                    <form action="loan_apply_do.php" method="POST" id="loanForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">月收入（元）<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="income" placeholder="请输入月收入" required data-money>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">就业状况 <span class="text-danger">*</span></label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="application_content" rows="4" 
                                          placeholder="请详细描述您的贷款用途、还款计划等信息" required></textarea>
                                <small class="text-muted">请提供详细的申请说明，包括贷款的具体用途、还款来源等信息，有助于加快审核进度。</small>
                            </div>
                        </div>
                    ...
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    审批通过后，您需签署贷款合同，系统将在约定日期自动从您的银行卡扣款。
                                </div>
                            </div>
                        </div>
                    </div>
