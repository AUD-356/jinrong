...
$investments = dbGetAll("SELECT i.*, p.name as product_name, p.expected_rate, p.type as product_type 
    ...
    WHERE i.user_id = ? AND i.user_type = 'personal' AND i.status = 'invested' 
...
<head>
    ...
    <title>投资理财 - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2><i class="bi bi-piggy-bank me-2"></i>投资理财</h2>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-primary fw-bold"><?php echo formatMoney($inv['amount']); ?></td>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row text-center mb-3">
                                <div class="col-4">
                                    <div class="text-primary fw-bold fs-5"><?php echo $product['expected_rate']; ?>%</div>
                            ...
                            <button class="btn btn-primary w-100" onclick="buyProduct(<?php echo $product['id']; ?>, '<?php echo addslashes($product['name']); ?>', <?php echo $product['min_amount']; ?>, <?php echo $product['max_amount']; ?>)">
