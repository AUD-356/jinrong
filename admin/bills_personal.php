...
$where = "b.user_type = 'personal'";
$params = [];
if ($search) {
    $where .= " AND (u.username LIKE ? OR u.real_name LIKE ? OR b.title LIKE ?)";
    $params[] = "%$search%";
    $params[] = "%$search%";
    $params[] = "%$search%";
}
...
$countSql = "SELECT COUNT(*) FROM bills b LEFT JOIN users u ON b.user_id = u.id WHERE $where";
$total = dbGetOne($countSql, $params);
$totalPages = ceil($total / $pageSize);
$offset = ($page - 1) * $pageSize;

$sql = "SELECT b.*, u.username, u.real_name FROM bills b LEFT JOIN users u ON b.user_id = u.id WHERE $where ORDER BY b.created_at DESC LIMIT $pageSize OFFSET $offset";
...
<div class="page-header mb-4">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h2><i class="bi bi-file-earmark-text me-2"></i>个人账单管理</h2>
            <p class="text-muted mb-0">查看所有个人用户账单记录</p>
        </div>
...
<div class="card-box">
    <form method="GET" class="mb-4">
        ...
        <div class="row g-3">
            <div class="col-md-3">
                <input type="text" class="form-control" name="search" placeholder="搜索用户名/姓名/标题" value="<?php echo htmlspecialchars($search); ?>">
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                ...
                <a href="bills_personal.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-counterclockwise me-1"></i>重置</a>
            </div>
        </div>
    </form>
        ...
        <table class="table table-hover" id="billsTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($bill['real_name']); ?></td>
...
function exportBills() {
    window.location.href = 'export_bills.php?type=personal&search=<?php echo urlencode($search); ?>&date_from=<?php echo urlencode($dateFrom); ?>&date_to=<?php echo urlencode($dateTo); ?>';
}
</script>
